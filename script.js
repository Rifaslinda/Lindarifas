...
function generarFactura(cliente, ancho) {
    ...
    const facturaContent = `
        <div id="factura-impresion" style="width: ${ancho}mm; padding: 3mm; font-family: 'Courier New', monospace; font-size: ${ancho === 58 ? '14px' : '14px'}; line-height: 1.2; font-weight: normal;">
            <h2 style="text-align: center; margin: 3px 0; font-size: ${ancho === 58 ? '16px' : '16px'}; font-weight: bold;">${titulo}</h2>
            <div style="text-align: center; margin: 3px 0; font-size: ${ancho === 58 ? '13px' : '13px'}; white-space: pre-line;">${encabezado}</div>
            <hr style="border-top: 1px dashed #000; margin: 4px 0;">
            <div style="margin: 4px 0; white-space: pre-line;">${cuerpo}</div>
            <hr style="border-top: 1px dashed #000; margin: 4px 0;">
            <div style="text-align: center; font-size: ${ancho === 58 ? '13px' : '13px'}; margin: 4px 0; white-space: pre-line;">${pie}</div>
            <div style="text-align: center; margin-top: 6px; font-size: ${ancho === 58 ? '12px' : '12px'};">${new Date().toLocaleString()}</div>
        </div>
    `;
